...
try {
    $flag = empty($_POST['firstname']) || empty($_POST['lastname']) || empty($_POST['email']) || empty($_POST['faculty']) || empty($_POST['address']) || empty($_POST['password']);
    ...
    $faculty = filterText($_POST['faculty']);
    ...
    /* echo "hello"; */
    $user = signup_new_user($firstname, $lastname, $email, $faculty, $address, $password, $target);
    if ($user) {
        $msg['title'] = 'Success!!';
