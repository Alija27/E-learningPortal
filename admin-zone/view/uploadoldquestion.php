...
<head>
    ...
    <title>Upload Old Questions </title>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Upload Old Questions</h4>
                                <ol class="breadcrumb p-0 m-0">
                                    <li>
                                        <a href="<?= $base_url ?>?r=dashboard">Admin</a>
                                    </li>
                                    <li>
                                        <a href="#">Upload Old Questions </a>
                                    </li>
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="p-6">
                                ...
                                <form class="form-horizantal" method="post" action=" <?= $base_url ?>?r=uploadoldquestion" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <label for="upload"> Upload Note</label>
