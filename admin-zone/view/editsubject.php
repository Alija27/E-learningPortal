                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h4 class="m-t-0 header-title"><b>Edit Subject</b></h4>
                            <hr />
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <form class="form-horizantal" method="post" action=" <?= $base_url ?>?r=editsubject&id=<?php echo $id ?>" enctype=" multipart/form-data">


                                        <label class="col-md-4 control-label">Subject Name</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" name="sub_name" value="<?php echo $course_data['sub_name']; ?>">
                                            <br>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <select name="course_id" class="form-control" value="<?php echo $course_data['course_id']; ?>">
                                        <?php
                                        $course = get_course();
                                        if ($course) {
                            ...
                            <div class=" form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="sub_code" placeholder="Enter Subject Code" value="<?php echo $course_data['sub_code']; ?>"><br>
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="credit_hr" placeholder="Enter Credit Hours" value="<?php echo $course_data['credit_hr']; ?>"><br>
