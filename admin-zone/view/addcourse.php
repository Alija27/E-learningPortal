                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-1">
                            <div class="p-6">
                                ...
                                <form class="form-horizantal" method="post" action=" <?= $base_url ?>?r=addcourse" enctype="multipart/form-data">
                                    <div class="form-group m-b-20">
                                        <label for="CourseName">Course Name</label>
                                        <input type="text" class="form-control" name="c_name" value="" placeholder="Enter Course">
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <textarea class="form-control" name="c_description"></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group m-b-20">
                                                ...
                                                <input type="text" class="form-control" name="c_duration" placeholder="Enter Course Duration">
                                            </div>
