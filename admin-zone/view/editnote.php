                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Edit Note</h4>
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="p-6">
                                ...
                                <form class="form-horizantal" method="post" action=" <?= $base_url ?>?r=uploadnote&id=<?php echo $id ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <label for="upload"> Edit Note</label>
