...
<head>
    ...
    <title>Edit Old Questions </title>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Edit Old Questions</h4>
                                <ol class="breadcrumb p-0 m-0">
                                    <li>
                                        <a href="<?= $base_url ?>?r=dashboard">Admin</a>
                                    </li>
                                    <li>
                                        <a href="#">Edit Old Questions </a>
                                    </li>
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="p-6">
                                ...
                                <form class="form-horizantal" method="post" action=" <?= $base_url ?>?r=editoldquestion&id=<?php echo $id ?>" enctype="multipart/form-data">
                                    <div class="form-group m-b-20">
                                        <label for="CourseName"> Year </label>
                                        <input type="text" class="form-control" name="years" value="" placeholder="Enter Course">
                                    </div>
                                    <div class="form-group m-b-20">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <label for="Edit"> Edit Note</label>
