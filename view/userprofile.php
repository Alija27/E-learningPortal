 ...
 <!-- <div class="container emp-profile">
     <form method="post" action="<?php echo $base_url; ?>?r=userprofile" enctype="multipart/form-data">
         ...
         <div class="row">
             <div class="col-md-2">
                 <a href="<?php echo $base_url ?>?r=editprofile"><input type="submit" class="profile-edit-btn" name="btnAddMore" value="Edit Profile"> </a>
             </div>
         </div>
 </div>
 </div>
     ...
     <div class="container">
         <div class="row d-flex justify-content-center">
             <div class="col-md-10 mt-5 pt-5 ">
                 <div class="row z-depth-3" style="border-style:groove; border-color:white">
                     <div class="col-sm-4  rounded-left" style="background-color:#091e39;">

                         <div class="card-block text-center text-white mt-3">

                             <img src="<?php echo $user_data['image_url']; ?>" alt="UserProfile" width=" 200px" style="border:5px solid white; border-radius:100%">
                             <br> <br>

                             <input type="submit" value="EDIT" style="border:5px solid white; border-radius:10%">
                     ...
                     <div class="col-sm-8 bg-white rounded-right">
                         ...
                         <div class="row">
                             <div class="col-sm-6">
                                 ...
                                 <h6 class="text-muted"> <?php echo $user_data['email']; ?> </h6>

                                 <p class="font-weight-bold"> Faculty </p>
                                 <h6 class="text-muted"> <?php echo $user_data['faculty']; ?> </h6>

                                 <p class="font-weight-bold"> Address </p>
                                 <h6 class="text-muted"> <?php echo $user_data['address']; ?> </h6>
